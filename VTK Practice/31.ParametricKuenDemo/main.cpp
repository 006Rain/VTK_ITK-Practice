...
public:
	...
	virtual void Execute( vtkObject *caller, unsigned long eventId, void *callData )
	{
		...
		if( value > 0.9 * this->Kuen->GetMaximumU() )
		{
			value = 0.99 * this->Kuen->GetMaximumU();
...
public:	
	...
	virtual void Execute( vtkObject *caller, unsigned long eventId, void *callData )
	{
		...
		double value = static_cast <vtkSliderRepresentation2D*>(sliderWidget->GetRepresentation())->GetValue();
		if( value < this->Kuen->GetMinimumU() + 0.01 )
		{
			value = this->Kuen->GetMinimumU() + 0.01;
			static_cast<vtkSliderRepresentation2D*>(sliderWidget->GetRepresentation())->SetValue( value );
		}
...
public:
	...
	virtual void Execute( vtkObject *caller, unsigned long eventId, void *callData )
	{
		...
		if( value > 0.9 * this->Kuen->GetMaximumV() )
		{
			value = 0.99 * this->Kuen->GetMaximumV();
			static_cast<vtkSliderRepresentation2D*>(sliderWidget->GetRepresentation())->SetValue( value );
		}
...
public:
	...
	virtual void Execute( vtkObject *caller, unsigned long eventId, void *callData )
	{
		...
		double value = static_cast <vtkSliderRepresentation2D*>(sliderWidget->GetRepresentation())->GetValue();
		if( value < this->Kuen->GetMinimumV() + 0.01 )
		{
			value = this->Kuen->GetMinimumV() + 0.01;
			static_cast<vtkSliderRepresentation2D*>(sliderWidget->GetRepresentation())->SetValue( value );
		}
...
int main()
{
	...
	vtkSmartPointer<vtkParametricKuen> surface = vtkSmartPointer<vtkParametricKuen>::New();
	...
	vtkSmartPointer<vtkProperty> backProptery = vtkSmartPointer<vtkProperty>::New();
	backProptery->SetColor( colors->GetColor3d( "Tomato" ).GetData() );
	...
	actor->SetBackfaceProperty( backProptery );
	...
	vtkSmartPointer<vtkSliderRepresentation2D> sliderRepMinimumU = vtkSmartPointer<vtkSliderRepresentation2D>::New();
	...
	vtkSmartPointer<vtkSliderWidget> sliderWidgetMinimumU = vtkSmartPointer<vtkSliderWidget>::New();
	...
	vtkSmartPointer<SliderCallbackMinimumU> callbackMinimumU = vtkSmartPointer<SliderCallbackMinimumU>::New();
